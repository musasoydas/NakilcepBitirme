...
class CompletedTransport : Fragment() {
    private lateinit var binding: FragmentCompletedTransportBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCompletedTransportBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        database.collection("Post").whereEqualTo("userId", userId).whereEqualTo("postStatus","completed")
            .addSnapshotListener { value, error ->
                if (value!!.isEmpty) {
                    binding.textView7.visibility = View.VISIBLE
                    binding.textView7.text = "Henüz Tamamlanmış İlanınız yoktur"
                }
    ...
    private fun recyclerAdapter() {
        ...
        binding.completedRecycler.layoutManager = layoutManager
        recyclerViewLoadsAdapter = LoadsAdapter(requireContext(), loadList)
        binding.completedRecycler.adapter = recyclerViewLoadsAdapter
    }
